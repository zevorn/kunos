...
This file is the shared entry point for Claude Code agents working in this repository.
Task-specific skills live under `.claude/skills/`.
...
- `.claude/skills/`: focused agent workflows.
